...
"C:\xampp\mysql\bin\mysql.exe" -u root silar_db -e "SHOW TABLES;" >nul 2>&1
if errorlevel 1 (
...
"C:\xampp\mysql\bin\mysql.exe" -u root silar_db -e "SELECT COUNT(*) as user_count FROM users;" | findstr "0" >nul 2>&1
if errorlevel 1 (
